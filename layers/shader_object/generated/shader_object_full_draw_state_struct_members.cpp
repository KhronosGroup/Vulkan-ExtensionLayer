...
VkFormat const& FullDrawStateData::GetDepthAttachmentFormat() const { return depth_attachment_format_; }
...
VkFormat const& FullDrawStateData::GetStencilAttachmentFormat() const { return stencil_attachment_format_; }
...
VkFormat const& FullDrawStateData::GetColorAttachmentFormat(uint32_t index) const { return color_attachment_formats_[index]; }
VkFormat const* FullDrawStateData::GetColorAttachmentFormatPtr() const { return color_attachment_formats_; }
...
ComparableShader const& FullDrawStateData::GetComparableShader(uint32_t index) const { return comparable_shaders_[index]; }
ComparableShader const* FullDrawStateData::GetComparableShaderPtr() const { return comparable_shaders_; }
void FullDrawStateData::SetCullMode(VkCullModeFlags const& element) {
    if (element == cull_mode_) {
        return;
    }
    dirty_hash_bits_.set(VK_EXT_extended_dynamic_state);
    MarkDirty();
    cull_mode_ = element;
}

VkCullModeFlags const& FullDrawStateData::GetCullMode() const { return cull_mode_; }
...
VkBool32 const& FullDrawStateData::GetDepthBoundsTestEnable() const { return depth_bounds_test_enable_; }
...
VkCompareOp const& FullDrawStateData::GetDepthCompareOp() const { return depth_compare_op_; }
...
VkBool32 const& FullDrawStateData::GetDepthTestEnable() const { return depth_test_enable_; }
...
VkBool32 const& FullDrawStateData::GetDepthWriteEnable() const { return depth_write_enable_; }
...
VkFrontFace const& FullDrawStateData::GetFrontFace() const { return front_face_; }
...
VkPrimitiveTopology const& FullDrawStateData::GetPrimitiveTopology() const { return primitive_topology_; }
...
uint32_t const& FullDrawStateData::GetNumScissors() const { return num_scissors_; }
...
uint32_t const& FullDrawStateData::GetNumViewports() const { return num_viewports_; }
...
VkStencilOpState const& FullDrawStateData::GetStencilFront() const { return stencil_front_; }
...
VkStencilOpState const& FullDrawStateData::GetStencilBack() const { return stencil_back_; }
...
VkBool32 const& FullDrawStateData::GetStencilTestEnable() const { return stencil_test_enable_; }
void FullDrawStateData::SetLogicOp(VkLogicOp const& element) {
    if (element == logic_op_) {
        return;
    }
    dirty_hash_bits_.set(VK_EXT_extended_dynamic_state2);
    MarkDirty();
    logic_op_ = element;
}

VkLogicOp const& FullDrawStateData::GetLogicOp() const { return logic_op_; }
...
VkBool32 const& FullDrawStateData::GetPrimitiveRestartEnable() const { return primitive_restart_enable_; }
...
VkBool32 const& FullDrawStateData::GetRasterizerDiscardEnable() const { return rasterizer_discard_enable_; }
...
VkBool32 const& FullDrawStateData::GetDepthBiasEnable() const { return depth_bias_enable_; }
...
uint32_t const& FullDrawStateData::GetPatchControlPoints() const { return patch_control_points_; }
void FullDrawStateData::SetPolygonMode(VkPolygonMode const& element) {
    if (element == polygon_mode_) {
        return;
    }
    dirty_hash_bits_.set(VK_EXT_extended_dynamic_state3);
    MarkDirty();
    polygon_mode_ = element;
}

VkPolygonMode const& FullDrawStateData::GetPolygonMode() const { return polygon_mode_; }
...
VkSampleCountFlagBits const& FullDrawStateData::GetRasterizationSamples() const { return rasterization_samples_; }
...
VkBool32 const& FullDrawStateData::GetLogicOpEnable() const { return logic_op_enable_; }
...
VkBool32 const& FullDrawStateData::GetDepthClampEnable() const { return depth_clamp_enable_; }
...
VkTessellationDomainOrigin const& FullDrawStateData::GetDomainOrigin() const { return domain_origin_; }
...
VkBool32 const& FullDrawStateData::GetAlphaToOneEnable() const { return alpha_to_one_enable_; }
...
VkBool32 const& FullDrawStateData::GetAlphaToCoverageEnable() const { return alpha_to_coverage_enable_; }
...
VkSampleMask const& FullDrawStateData::GetSampleMask(uint32_t index) const { return sample_masks_[index]; }
VkSampleMask const* FullDrawStateData::GetSampleMaskPtr() const { return sample_masks_; }
...
uint32_t const& FullDrawStateData::GetRasterizationStream() const { return rasterization_stream_; }
...
float const& FullDrawStateData::GetExtraPrimitiveOverestimationSize() const { return extra_primitive_overestimation_size_; }
...
VkBool32 const& FullDrawStateData::GetDepthClipEnable() const { return depth_clip_enable_; }
...
VkBool32 const& FullDrawStateData::GetSampleLocationsEnable() const { return sample_locations_enable_; }
...
VkProvokingVertexModeEXT const& FullDrawStateData::GetProvokingVertexMode() const { return provoking_vertex_mode_; }
...
VkLineRasterizationModeEXT const& FullDrawStateData::GetLineRasterizationMode() const { return line_rasterization_mode_; }
...
VkBool32 const& FullDrawStateData::GetStippledLineEnable() const { return stippled_line_enable_; }
...
VkCoverageModulationModeNV const& FullDrawStateData::GetCoverageModulationMode() const { return coverage_modulation_mode_; }
...
VkBool32 const& FullDrawStateData::GetCoverageModulationTableEnable() const { return coverage_modulation_table_enable_; }
...
float const* FullDrawStateData::GetCoverageModulationTableValuesPtr() const { return coverage_modulation_table_valuess_; }
...
VkCoverageReductionModeNV const& FullDrawStateData::GetCoverageReductionMode() const { return coverage_reduction_mode_; }
...
VkBool32 const& FullDrawStateData::GetCoverageToColorEnable() const { return coverage_to_color_enable_; }
...
uint32_t const& FullDrawStateData::GetCoverageToColorLocation() const { return coverage_to_color_location_; }
...
VkBool32 const& FullDrawStateData::GetViewportWScalingEnable() const { return viewport_w_scaling_enable_; }
...
uint32_t const& FullDrawStateData::GetViewportSwizzleCount() const { return viewport_swizzle_count_; }
...
VkViewportSwizzleNV const& FullDrawStateData::GetViewportSwizzle(uint32_t index) const { return viewport_swizzles_[index]; }
VkViewportSwizzleNV const* FullDrawStateData::GetViewportSwizzlePtr() const { return viewport_swizzles_; }
...
VkBool32 const& FullDrawStateData::GetRepresentativeFragmentTestEnable() const { return representative_fragment_test_enable_; }
void FullDrawStateData::SetVertexInputAttributeDescription(uint32_t index, VkVertexInputAttributeDescription const& element) {
    ...
    dirty_hash_bits_.set(VK_EXT_vertex_input_dynamic_state);
    MarkDirty();
...
uint32_t const& FullDrawStateData::GetNumVertexInputBindingDescriptions() const { return num_vertex_input_binding_descriptions_; }
bool FullDrawStateData::operator==(FullDrawStateData const& o) const {
    if (!(o.depth_attachment_format_ == depth_attachment_format_) &&
        (!o.dynamic_rendering_unused_attachments_ || o.depth_attachment_format_ != VK_FORMAT_UNDEFINED) &&
        (!dynamic_rendering_unused_attachments_ || depth_attachment_format_ != VK_FORMAT_UNDEFINED)) {
        return false;
    }

    if (!(o.stencil_attachment_format_ == stencil_attachment_format_) &&
        (!o.dynamic_rendering_unused_attachments_ || o.stencil_attachment_format_ != VK_FORMAT_UNDEFINED) &&
        (!dynamic_rendering_unused_attachments_ || stencil_attachment_format_ != VK_FORMAT_UNDEFINED)) {
        return false;
    }
    ...
    for (uint32_t i = 0; i < limits_.max_color_attachments; ++i) {
        if (!(o.color_attachment_formats_[i] == color_attachment_formats_[i]) &&
            (!o.dynamic_rendering_unused_attachments_ || o.color_attachment_formats_[i] != VK_FORMAT_UNDEFINED) &&
    ...
    if (!(o.num_color_attachments_ == num_color_attachments_) &&
        (!o.dynamic_rendering_unused_attachments_ && !dynamic_rendering_unused_attachments_)) {
        return false;
    }
