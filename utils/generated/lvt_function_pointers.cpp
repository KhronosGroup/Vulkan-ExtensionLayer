...
#endif // VK_USE_PLATFORM_WIN32_KHR
    GetSemaphoreCounterValueKHR = reinterpret_cast<PFN_vkGetSemaphoreCounterValueKHR>(get_proc_address(lib_handle, "vkGetSemaphoreCounterValueKHR"));
    WaitSemaphoresKHR = reinterpret_cast<PFN_vkWaitSemaphoresKHR>(get_proc_address(lib_handle, "vkWaitSemaphoresKHR"));
    SignalSemaphoreKHR = reinterpret_cast<PFN_vkSignalSemaphoreKHR>(get_proc_address(lib_handle, "vkSignalSemaphoreKHR"));
    CmdSetEvent2KHR = reinterpret_cast<PFN_vkCmdSetEvent2KHR>(get_proc_address(lib_handle, "vkCmdSetEvent2KHR"));
    CmdResetEvent2KHR = reinterpret_cast<PFN_vkCmdResetEvent2KHR>(get_proc_address(lib_handle, "vkCmdResetEvent2KHR"));
    CmdWaitEvents2KHR = reinterpret_cast<PFN_vkCmdWaitEvents2KHR>(get_proc_address(lib_handle, "vkCmdWaitEvents2KHR"));
    CmdPipelineBarrier2KHR = reinterpret_cast<PFN_vkCmdPipelineBarrier2KHR>(get_proc_address(lib_handle, "vkCmdPipelineBarrier2KHR"));
