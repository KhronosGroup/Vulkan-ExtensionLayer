...
#endif // VK_USE_PLATFORM_WIN32_KHR
    GetSemaphoreCounterValueKHR = reinterpret_cast<PFN_vkGetSemaphoreCounterValueKHR>(loader_platform_get_proc_address(loader_handle, "vkGetSemaphoreCounterValueKHR"));
    WaitSemaphoresKHR = reinterpret_cast<PFN_vkWaitSemaphoresKHR>(loader_platform_get_proc_address(loader_handle, "vkWaitSemaphoresKHR"));
    SignalSemaphoreKHR = reinterpret_cast<PFN_vkSignalSemaphoreKHR>(loader_platform_get_proc_address(loader_handle, "vkSignalSemaphoreKHR"));
    CmdSetEvent2KHR = reinterpret_cast<PFN_vkCmdSetEvent2KHR>(loader_platform_get_proc_address(loader_handle, "vkCmdSetEvent2KHR"));
    CmdResetEvent2KHR = reinterpret_cast<PFN_vkCmdResetEvent2KHR>(loader_platform_get_proc_address(loader_handle, "vkCmdResetEvent2KHR"));
    CmdWaitEvents2KHR = reinterpret_cast<PFN_vkCmdWaitEvents2KHR>(loader_platform_get_proc_address(loader_handle, "vkCmdWaitEvents2KHR"));
    CmdPipelineBarrier2KHR = reinterpret_cast<PFN_vkCmdPipelineBarrier2KHR>(loader_platform_get_proc_address(loader_handle, "vkCmdPipelineBarrier2KHR"));
    CmdWriteTimestamp2KHR = reinterpret_cast<PFN_vkCmdWriteTimestamp2KHR>(loader_platform_get_proc_address(loader_handle, "vkCmdWriteTimestamp2KHR"));
    QueueSubmit2KHR = reinterpret_cast<PFN_vkQueueSubmit2KHR>(loader_platform_get_proc_address(loader_handle, "vkQueueSubmit2KHR"));
    CmdWriteBufferMarker2AMD = reinterpret_cast<PFN_vkCmdWriteBufferMarker2AMD>(loader_platform_get_proc_address(loader_handle, "vkCmdWriteBufferMarker2AMD"));
    GetQueueCheckpointData2NV = reinterpret_cast<PFN_vkGetQueueCheckpointData2NV>(loader_platform_get_proc_address(loader_handle, "vkGetQueueCheckpointData2NV"));
#ifdef VK_USE_PLATFORM_MACOS_MVK
